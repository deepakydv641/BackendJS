  ...
  useEffect(() => {
    const fetchSearchResults = async () => {
      ...
      try {
        ...
        const res = await axios.get(`${import.meta.env.MODE === 'development' ? 'http://localhost' : 'https://vidstream-th0g.onrender.com'}/api/v1/search/search?q=${encodeURIComponent(query)}`, { 
